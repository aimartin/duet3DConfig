...
M550 HyperCube		                            ; Set machine name
...
;M208 X-40 Y-50 Z0 S1                            ; Set axis minima (-40,-35,0)
;M208 X200 Y150 Z129 S0                          ; Set axis maxima (200,180,129)
...
;M915 P1 S12 F0 H200 R1				; Configure Stall Detection - Drive 1 (Y), Sensibility 12, Unfiltered (F0), 200 Min Steps, Inform (R1)
;M574 Y1 S3 					; Set endstop configuration (Y endstops only, Motor Load mode)
;M915 P0 S12 F0 H200 R1				; Configure Stall Detection - Drive 0 (X), Sensibility 12, Unfiltered (F0), 200 Min Steps, Inform (R1)
...
;M307 H1 A575.0 C225.7 D3.7 S1.00 V12.1 B0	; Use PID on Main Heater - Heater 1 model: gain 575.0, time constant 225.7, dead time 3.7, max PWM 1.00, calibration voltage 12.1, mode PID 40w
;M307 H1 A308.9 C154.4 D4.3 S1.00 V12.0 B0	; Use PID on Main Heater - Heater 1 model: gain 308.9, time constant 154.4, dead time 4.3, max PWM 1.00, calibration voltage 12.0, mode PID 30w
...
;M106 P2 S1 I0 F500 H1 T50                    ; Set fan 2 value, PWM signal inversion and frequency. Thermostatic control is turned on - LEDs
